...
struct Strings {
    ...
    let keepAwakeActiveIconOmniBar: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "OmniBar: suspensão normal",
        statusActiveUntil: "OmniBar: ativo até",
        statusActiveIndefinite: "OmniBar: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o OmniBar",
        menuQuit: "Sair do OmniBar",
        menuHide: "Ocultar o OmniBar",
        ...
        keepAwakeActiveIconOmniBar: "OmniBar",
        ...
        notifyBatteryTitle: "OmniBar desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O OmniBar precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O OmniBar precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O OmniBar foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O OmniBar precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O OmniBar vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O OmniBar vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do OmniBar",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao OmniBar (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o OmniBar para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o OmniBar completamente",
        advancedUninstallConfirmTitle: "Desinstalar o OmniBar?",
        advancedUninstallConfirmBody: "O OmniBar vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O OmniBar não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o OmniBar",
        ...
        switcherEnable: "Usar o alternador do OmniBar",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do OmniBar estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o OmniBar na lista. Se ele não aparecer, clique no + e escolha o OmniBar em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O OmniBar pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O OmniBar pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O OmniBar não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do OmniBar",
        ...
        updateNeedsApplicationsTitle: "Mova o OmniBar para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o OmniBar para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o OmniBar",
        obStepWelcomeTitle: "Bem-vindo ao OmniBar",
        ...
        obStepDoneBody: "O OmniBar já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O OmniBar agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o OmniBar precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o OmniBar a continuar crescendo",
        donateMessage: "O OmniBar é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o OmniBar a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o OmniBar e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do OmniBar no Discord está começando",
        discordIntroMessage: "A comunidade do OmniBar é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        homebrewOfficialIntroMessage: "O OmniBar agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do OmniBar sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o OmniBar pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o OmniBar lá, ou configure o %@ para sempre mostrar o OmniBar.",
        ...
        cleanerNotifDenied: "As notificações do OmniBar estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o OmniBar para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o OmniBar em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do OmniBar.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "OmniBar: normal sleep",
        statusActiveUntil: "OmniBar: awake until",
        statusActiveIndefinite: "OmniBar: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About OmniBar",
        menuQuit: "Quit OmniBar",
        menuHide: "Hide OmniBar",
        ...
        notifyBatteryTitle: "OmniBar disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "OmniBar needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "OmniBar needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "OmniBar quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "OmniBar needs your password to install the update.",
        adminPromptSudoersInstall: "OmniBar will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "OmniBar will remove the password-free closed-lid rule.",

        settingsTitle: "OmniBar Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted OmniBar (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves OmniBar to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall OmniBar completely",
        advancedUninstallConfirmTitle: "Uninstall OmniBar?",
        advancedUninstallConfirmBody: "OmniBar will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "OmniBar could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when OmniBar opens",
        ...
        switcherEnable: "Use the OmniBar switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while OmniBar’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn OmniBar on in the list. If it isn’t there, click + and pick OmniBar from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "OmniBar can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. OmniBar can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. OmniBar does not capture passwords.",
        ...
        updateNotifyTitle: "OmniBar update",
        ...
        updateNeedsApplicationsTitle: "Move OmniBar to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag OmniBar to the Applications folder, open it from there and try again.",
        ...
        aboutDescription: "A comprehensive menu bar utility hub for macOS, optimized for Intel and Apple Silicon Macs.\n\nBased on the open-source project vorssaint-utils (GPL-3.0) by @vorssaint. Forked, redesigned, and enhanced by Medelcartelinc.",
        ...
        obStart: "Open OmniBar",
        obStepWelcomeTitle: "Welcome to OmniBar",
        ...
        obStepDoneBody: "OmniBar is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "OmniBar now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, OmniBar needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Support OmniBar Development",
        donateMessage: "OmniBar is free, independent, and open source. A star on GitHub or sharing feedback directly helps support development and compatibility for Intel and Apple Silicon Macs.",
        donateButton: "Visit Repository on GitHub",
        donateThanks: "Thank you for your support! 🖤",
        supportIntroTitle: "Support OmniBar Development",
        supportIntroMessage: "OmniBar is free and open source. You can support the project by leaving a star on GitHub or contributing.",
        supportIntroStarButton: "Star OmniBar on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover OmniBar and makes a real difference to its growth.",
        supportIntroCoffeeButton: "Visit Repository",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "Community & Development on GitHub",
        discordIntroMessage: "Have an idea, want to suggest a feature, or report an issue? Join the community directly on GitHub.",
        discordIntroJoinButton: "Open GitHub Community",
        communityIntroTitle: "Stay updated on OmniBar",
        communityIntroMessage: "Follow news, releases, and discussions on the official GitHub repository and developer profile.",
        communityIntroFollowButton: "Medelcartelinc GitHub Profile",
        homebrewOfficialIntroTitle: "Installation & Updates",
        homebrewOfficialIntroMessage: "OmniBar can be installed or updated easily from GitHub.",
        ...
        showMenuBarIconCaption: "If OmniBar’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen OmniBar from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for OmniBar there, or set %@ to always show OmniBar.",
        ...
        cleanerNotifDenied: "OmniBar notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag OmniBar to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn OmniBar on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or OmniBar quits.",
