...
extension BluetoothSleepStrings {
    static let enUS = BluetoothSleepStrings(
        ...
        restoreCaption: "Only when OmniBar was the one that switched it off.",
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o OmniBar que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan OmniBar olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам OmniBar.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue OmniBar quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn OmniBar es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est OmniBar qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato OmniBar a spegnerlo.",
    ...
    static let ja = BluetoothSleepStrings(
        ...
        restoreCaption: "OmniBarが切った場合のみ戻します。",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "OmniBar가 껐을 때만 다시 켭니다.",
    ...
    static let zhHans = BluetoothSleepStrings(
        ...
        restoreCaption: "仅在蓝牙是由 OmniBar 关闭时。",
    ...
    static let zhTW = BluetoothSleepStrings(
        ...
        restoreCaption: "僅在藍牙是由 OmniBar 關閉時。",
    ...
    static let zhHK = BluetoothSleepStrings(
        ...
        restoreToggle: "Mac 喚醒時重新開啟藍牙",
        restoreCaption: "只在藍牙是由 OmniBar 關閉時。",
