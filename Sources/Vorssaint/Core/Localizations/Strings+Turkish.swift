...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "OmniBar: normal uyku",
        statusActiveUntil: "OmniBar: şu zamana kadar uyanık",
        statusActiveIndefinite: "OmniBar: süresiz uyanık",
        ...
        menuAbout: "OmniBar Hakkında",
        menuQuit: "OmniBar’ten Çık",
        menuHide: "OmniBar’i Gizle",
        ...
        notifyBatteryTitle: "OmniBar devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "OmniBar’in, Mac’i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "OmniBar’in, Mac’in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac’in uykusu kapalıyken OmniBar kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "OmniBar güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "OmniBar, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "OmniBar, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "OmniBar Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "OmniBar’e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve OmniBar’i Çöp Sepeti’ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "OmniBar’i tamamen kaldır",
        advancedUninstallConfirmTitle: "OmniBar kaldırılsın mı?",
        advancedUninstallConfirmBody: "OmniBar izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti’ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti’ni boşaltana kadar orada kalır.",
        advancedUninstallFailedTitle: "Kaldırma durduruldu",
        advancedUninstallFailedBody: "OmniBar değiştirdiği bir sistem ayarını geri alamadı: uyku, fan hızı veya fare hızlandırması. Hiçbir şey silinmedi. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        keepAwakeAutoStart: "OmniBar açılınca uyanık tut",
        ...
        switcherEnable: "OmniBar değiştiricisini kullan",
        ...
        switcherTakeOverSystemShortcutsCaption: "Eşleşen macOS uygulama ve pencere kısayollarını yalnızca OmniBar değiştiricisi etkinken kapatır. Çalışan tüm uygulamalara erişim korunur.",
        ...
        uninstallerFDAHint: "Listede OmniBar’i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar’dan OmniBar’i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "OmniBar, resmi Homebrew yükleyicisiyle Terminal’i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. OmniBar, kurulum komutuyla Terminal’i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal’e ihtiyaç duyar. OmniBar parolaları yakalamaz.",
        ...
        updateNotifyTitle: "OmniBar güncellemesi",
        ...
        updateNeedsApplicationsTitle: "OmniBar’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. OmniBar’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        obStart: "OmniBar’i aç",
        obStepWelcomeTitle: "OmniBar’e hoş geldin",
        ...
        obStepDoneBody: "OmniBar Mac’inle ilgilenmeye başladı bile.",
        ...
        obLanguageUpdateBody: "OmniBar artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar’dan değiştirebilirsin.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için OmniBar’in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları’ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "OmniBar’in gelişmesine destek ol",
        donateMessage: "OmniBar ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "OmniBar’in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub’da OmniBar’e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub’da verilen bir yıldız, daha fazla kişinin OmniBar’i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "OmniBar Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "OmniBar topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        homebrewOfficialIntroMessage: "OmniBar artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "OmniBar simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac’lerde yaygındır), OmniBar’i Uygulamalar’dan veya Spotlight’tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. OmniBar’i orada arayın veya %@ uygulamasını OmniBar’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "OmniBar bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. OmniBar’i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları’nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar’ı açın ve “Oturum açılırken aç” altında OmniBar’i açın.",
        ...
        mouseAccelerationCaption: "Bağlı farelerde işaretçi hızlandırmasını kaldırır. Seçenek kapatıldığında veya OmniBar’ten çıkıldığında önceki ayar geri yüklenir.",
