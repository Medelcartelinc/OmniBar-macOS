...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "OmniBar: reposo normal",
        statusActiveUntil: "OmniBar: activo hasta",
        statusActiveIndefinite: "OmniBar: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de OmniBar",
        menuQuit: "Salir de OmniBar",
        menuHide: "Ocultar OmniBar",
        ...
        notifyBatteryTitle: "OmniBar desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "OmniBar necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "OmniBar necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "OmniBar se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "OmniBar necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "OmniBar creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "OmniBar eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de OmniBar",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a OmniBar (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve OmniBar a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar OmniBar por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar OmniBar?",
        advancedUninstallConfirmBody: "OmniBar borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        advancedUninstallFailedTitle: "La desinstalación se detuvo",
        advancedUninstallFailedBody: "OmniBar no pudo restaurar un ajuste del sistema que había cambiado: la suspensión, la velocidad de los ventiladores o la aceleración del ratón. No se eliminó nada. Inténtalo de nuevo y permite la solicitud de contraseña si aparece.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir OmniBar",
        ...
        switcherEnable: "Usar el selector de OmniBar",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desactiva los atajos correspondientes de macOS solo mientras el selector de OmniBar está activo. Todas las apps abiertas siguen accesibles.",
        ...
        uninstallerFDAHint: "Activa OmniBar en la lista. Si no aparece, haz clic en + y elige OmniBar en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "OmniBar puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. OmniBar puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. OmniBar no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de OmniBar",
        ...
        updateNeedsApplicationsTitle: "Mueve OmniBar a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra OmniBar a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir OmniBar",
        obStepWelcomeTitle: "Te damos la bienvenida a OmniBar",
        ...
        obStepDoneBody: "OmniBar ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "OmniBar ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, OmniBar necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que OmniBar siga creciendo",
        donateMessage: "OmniBar es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que OmniBar siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a OmniBar en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran OmniBar y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de OmniBar en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de OmniBar es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        homebrewOfficialIntroMessage: "OmniBar ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de OmniBar desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir OmniBar desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca OmniBar ahí, o configura %@ para mostrar siempre OmniBar.",
        ...
        cleanerNotifDenied: "Las notificaciones de OmniBar están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra OmniBar a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa OmniBar en “Abrir al iniciar sesión”.",
        ...
        mouseAccelerationCaption: "Elimina la aceleración del puntero para los ratones conectados. El ajuste anterior vuelve al desactivarlo o salir de OmniBar.",
