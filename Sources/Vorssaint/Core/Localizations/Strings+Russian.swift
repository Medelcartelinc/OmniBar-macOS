...
extension Strings {
    static let ru = Strings(
        statusIdleTooltip: "OmniBar: обычный сон",
        statusActiveUntil: "OmniBar: активно до",
        statusActiveIndefinite: "OmniBar: активно без срока",
        menuEnableAwake: "Включить режим без сна",
        menuDisableAwake: "Выключить режим без сна",
        menuActivateFor: "Включить на…",
        menuSettings: "Настройки…",
        menuAbout: "О OmniBar",
        menuQuit: "Выйти из OmniBar",
        menuHide: "Скрыть OmniBar",
        ...
        notifyBatteryTitle: "OmniBar отключён",
        notifyBatteryBody: "Низкий заряд. Обычный сон восстановлен, чтобы сохранить батарею.",
        adminPromptClamshellOn: "OmniBar нужен ваш пароль, чтобы Mac продолжал работать с закрытой крышкой.",
        adminPromptClamshellOff: "OmniBar нужен ваш пароль, чтобы вернуть обычный режим сна Mac.",
        adminPromptRecover: "OmniBar завершился, пока сон Mac был отключён. Введите пароль, чтобы вернуть обычный режим сна.",
        adminPromptUpdate: "OmniBar нужен ваш пароль, чтобы установить обновление.",
        adminPromptSudoersInstall: "OmniBar создаст ограниченное правило (только pmset disablesleep), чтобы переключать режим закрытой крышки без запроса пароля. Пароль понадобится только сейчас.",
        adminPromptSudoersRemove: "OmniBar удалит правило для режима закрытой крышки без пароля.",

        settingsTitle: "Настройки OmniBar",
        tabGeneral: "Основное",
        tabEnergy: "Питание",
        ...
        advancedResetDescription: "Удаляет все разрешения, которые вы дали OmniBar (Универсальный доступ, Запись экрана, Полный доступ к диску и другие), элемент входа и правило закрытой крышки. Полезно, если хотите начать с чистого листа или перед удалением. Приложение останется установленным.",
        ...
        advancedUninstallDescription: "Сделает всё вышеперечисленное, затем удалит настройки и переместит OmniBar в Корзину без остатка. После завершения приложение закроется. Установить его снова можно в любой момент.",
        advancedUninstallButton: "Удалить OmniBar полностью",
        advancedUninstallConfirmTitle: "Удалить OmniBar?",
        advancedUninstallConfirmBody: "OmniBar очистит разрешения, удалит настройки и переместится в Корзину, после чего закроется. Это нельзя отменить из приложения, но файл останется в Корзине, пока вы её не очистите.",
        advancedUninstallFailedTitle: "Удаление остановлено",
        advancedUninstallFailedBody: "OmniBar не смог вернуть изменённую системную настройку: режим сна, скорость вентиляторов или ускорение мыши. Ничего не удалено. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        keepAwakeAutoStart: "Не давать уснуть при запуске OmniBar",
        ...
        switcherEnable: "Использовать переключатель OmniBar",
        ...
        switcherTakeOverSystemShortcutsCaption: "Отключает соответствующие сочетания macOS только на время работы переключателя OmniBar. Все запущенные приложения остаются доступны.",
        ...
        uninstallerFDAHint: "Включите OmniBar в списке. Если его там нет, нажмите + и выберите OmniBar из папки «Программы». Доступ начнёт действовать только после повторного запуска приложения.",
        ...
        homebrewMissingBody: "OmniBar может открыть Терминал с официальным установщиком Homebrew. Терминал покажет шаги и при необходимости запросит ваш пароль.",
        ...
        homebrewShellSetupBody: "Homebrew установлен, но Терминал может ещё не видеть команду brew. OmniBar может открыть Терминал с нужной командой настройки.",
        ...
        homebrewTerminalFallback: "Для этой операции нужен Терминал, чтобы запросить пароль администратора. OmniBar не перехватывает пароли.",
        ...
        updateNotifyTitle: "Обновление OmniBar",
        ...
        updateNeedsApplicationsTitle: "Переместите OmniBar в папку «Программы»",
        updateNeedsApplicationsBody: "Приложение запущено из места, которое нельзя обновить, например из образа диска или временного системного расположения. Перетащите OmniBar в папку «Программы», откройте его оттуда и попробуйте снова.",
        ...
        obStart: "Открыть OmniBar",
        obStepWelcomeTitle: "Добро пожаловать в OmniBar",
        ...
        obStepDoneBody: "OmniBar уже заботится о вашем Mac.",
        ...
        obLanguageUpdateBody: "Теперь OmniBar говорит на нескольких языках. Выберите тот, который хотите использовать; в любой момент его можно сменить в Настройках.",
        ...
        cleaningNeedsAxBody: "Чтобы безопасно блокировать клавиатуру, OmniBar нужен доступ к Универсальному доступу. Выдайте его в Системных настройках и попробуйте снова.",
        ...
        donateHeading: "Помогите OmniBar развиваться",
        donateMessage: "OmniBar бесплатен, независим и создаётся в моё свободное время. Если вы хотите помочь финансово, Buy Me a Coffee напрямую поддерживает дальнейшую разработку.",
        donateButton: "Поддержать через Buy Me a Coffee",
        donateThanks: "Спасибо, что вы здесь. 🖤",
        supportIntroTitle: "Помогите OmniBar развиваться",
        supportIntroMessage: "Если вы хотите финансово поддержать разработку, сделать это можно только через Buy Me a Coffee.",
        supportIntroStarButton: "Поставить OmniBar звезду на GitHub",
        supportIntroStarMessage: "Финансовая поддержка совсем не обязательна. Звезда на GitHub помогает большему числу людей найти OmniBar и действительно влияет на его развитие.",
        supportIntroCoffeeButton: "Поддержать через Buy Me a Coffee",
        supportIntroLaterButton: "Не сейчас",
        supportIntroDoneButton: "Готово",
        discordIntroTitle: "Сообщество OmniBar в Discord только начинает расти",
        discordIntroMessage: "Сообщество OmniBar новое и всё ещё формируется. Присоединяйтесь сейчас, знакомьтесь с другими пользователями и помогите создать дружелюбное пространство вокруг приложения.",
        ...
        homebrewOfficialIntroMessage: "Теперь OmniBar можно установить прямо из официального каталога Homebrew.",
        ...
        showMenuBarIconCaption: "Если значок OmniBar исчезнет (macOS может скрывать значки строки меню, когда в ней не хватает места, что часто бывает на Mac с вырезом), откройте OmniBar снова из папки «Программы» или через Spotlight: это пересоздаст значок и, если он всё ещё скрыт, откроет это окно.",
        ...
        menuBarIconManagerHintFormat: "%@ запущен и, возможно, держит значок в своей скрытой секции. Поищите OmniBar там или настройте %@ всегда показывать OmniBar.",
        ...
        cleanerNotifDenied: "Уведомления OmniBar отключены в системе.",
        cleanerNotifOpenSettings: "Открыть настройки уведомлений…",
        launchAtLoginNeedsApplications: "Приложение запущено из места, из которого нельзя открываться при входе. Перетащите OmniBar в папку «Программы», откройте его оттуда и включите параметр снова.",
        launchAtLoginNeedsApproval: "Объект входа зарегистрирован, но в Системных настройках он выключен. Откройте «Системные настройки › Основные › Объекты входа и расширения» и включите OmniBar в разделе «Открывать при входе».",
        ...
        mouseAccelerationCaption: "Отключает ускорение указателя для подключённых мышей. Прежняя настройка вернётся после выключения функции или выхода из OmniBar.",
