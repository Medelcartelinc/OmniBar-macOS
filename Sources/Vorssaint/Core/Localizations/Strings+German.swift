...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "OmniBar: normaler Ruhezustand",
        statusActiveUntil: "OmniBar: aktiv bis",
        statusActiveIndefinite: "OmniBar: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über OmniBar",
        menuQuit: "OmniBar beenden",
        menuHide: "OmniBar ausblenden",
        ...
        notifyBatteryTitle: "OmniBar deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "OmniBar benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "OmniBar benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "OmniBar wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "OmniBar benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "OmniBar legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "OmniBar entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "OmniBar-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du OmniBar erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt OmniBar in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "OmniBar vollständig deinstallieren",
        advancedUninstallConfirmTitle: "OmniBar deinstallieren?",
        advancedUninstallConfirmBody: "OmniBar setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        advancedUninstallFailedTitle: "Deinstallation gestoppt",
        advancedUninstallFailedBody: "OmniBar konnte eine geänderte Systemeinstellung nicht wiederherstellen: Ruhezustand, Lüfterdrehzahl oder Mausbeschleunigung. Es wurde nichts entfernt. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von OmniBar wach halten",
        ...
        switcherEnable: "OmniBar-Umschalter verwenden",
        ...
        switcherTakeOverSystemShortcutsCaption: "Deaktiviert die passenden macOS-App- und Fensterkurzbefehle nur, solange OmniBars Umschalter aktiv ist. Alle laufenden Apps bleiben erreichbar.",
        ...
        uninstallerFDAHint: "Aktiviere OmniBar in der Liste. Fehlt es dort, klicke auf + und wähle OmniBar unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "OmniBar kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. OmniBar kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. OmniBar erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege OmniBar in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe OmniBar in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        obStart: "OmniBar öffnen",
        obStepWelcomeTitle: "Willkommen bei OmniBar",
        ...
        obStepDoneBody: "OmniBar kümmert sich bereits um deinen Mac.",
        ...
        obLanguageUpdateBody: "OmniBar spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt OmniBar die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf OmniBar weiter zu wachsen",
        donateMessage: "OmniBar ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft Buy Me a Coffee direkt dabei, sie voranzubringen.",
        donateButton: "Über Buy Me a Coffee unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf OmniBar weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist Buy Me a Coffee der einzige Ort dafür.",
        supportIntroStarButton: "OmniBar auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, OmniBar zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        ...
        discordIntroTitle: "Die OmniBar Community auf Discord steht noch am Anfang",
        discordIntroMessage: "Die OmniBar Community ist neu und wächst noch. Tritt früh bei, lerne andere Nutzer kennen und hilf, einen einladenden Ort rund um die App aufzubauen.",
        ...
        homebrewOfficialIntroMessage: "OmniBar kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von OmniBar verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne OmniBar erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche OmniBar dort, oder stelle %@ so ein, dass OmniBar immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von OmniBar sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe OmniBar in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte OmniBar unter „Bei der Anmeldung öffnen“ ein.",
        ...
        mouseAccelerationCaption: "Deaktiviert die Zeigerbeschleunigung für angeschlossene Mäuse. Die vorherige Einstellung wird beim Ausschalten oder Beenden von OmniBar wiederhergestellt.",
