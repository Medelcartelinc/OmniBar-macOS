...
extension MouseButtonFeatureStrings {
    static let enUS = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar cannot watch the mouse right now.",
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        captureBlind: "O OmniBar não consegue observar o mouse agora.",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar şu anda fareyi izleyemiyor.",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar сейчас не может отслеживать мышь.",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        captureCancel: "Cancelar",
        captureBlind: "OmniBar no puede observar el ratón ahora mismo.",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar kann die Maus gerade nicht beobachten.",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar ne peut pas observer la souris pour le moment.",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        captureBlind: "OmniBar al momento non riesce a osservare il mouse.",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        captureCancel: "キャンセル",
        captureBlind: "OmniBarは今マウスを監視できません。",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        captureCancel: "취소",
        captureBlind: "OmniBar가 지금은 마우스를 지켜볼 수 없습니다.",
